...
$table_name = 'wp_anvandare_test';

$kontakt_table_name = 'wp_anvandare_kontakt_test';

$child_table_name = 'wp_child_records_test';
 ...
 */
	...
	//echo "<pre>"; print_r($HamtaProjektResult);
...

		{
			...
			echo $final_query = $query_part1.$query_part2.$query_part3;
			//die;
				print_r($final_query);
				echo '<br/><br/>------------------------------------------';
